    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "TDS - Technology Driven Strategies uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '88f282dd-e571-45f4-8d70-b34c68740805',
                    name: data.name || '',
                    email: data.email || '',
